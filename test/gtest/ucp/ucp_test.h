...
public:
    ...
    public:
        ...
        ucp_ep_h accept(ucp_worker_h worker, ucp_ep_address_t *ep_addr);
    ...
    protected:
        ...
        std::queue<ucp_ep_address_t *>  m_ep_addrs;
    ...
    private:
        ...
        static void accept_ep_addr_cb(ucp_ep_address_t *ep_addr, void *arg);
