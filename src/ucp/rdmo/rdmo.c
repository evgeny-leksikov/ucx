...
//                 (ep, opcode, buffer, count, rkey, param),
//                 ucp_ep_h ep, ucp_rdmo_op_t opcode, const void *buffer,
//                 size_t count, ucp_rkey_h rkey, const ucp_request_param_t *param)
//{
...
//
//    if (ENABLE_PARAMS_CHECK &&
//        ucs_unlikely(!(param->op_attr_mask & UCP_OP_ATTR_FIELD_REPLY_BUFFER))) {
//        ucs_error("reply buffer is not set");
//        return UCS_STATUS_PTR(UCS_ERR_INVALID_PARAM);
//    }
//
//    if (ENABLE_PARAMS_CHECK &&
//        ucs_unlikely(!(param->op_attr_mask & UCP_OP_ATTR_FIELD_REPLY_MEMH))) {
//        ucs_error("reply memory handle is not set");
//        return UCS_STATUS_PTR(UCS_ERR_INVALID_PARAM);
//    }
//
//    return ucp_rdmo_append(ep, buffer, count, rkey, param);
//}
