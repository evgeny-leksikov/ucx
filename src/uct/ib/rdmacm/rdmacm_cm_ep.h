...
enum {
    ...
    UCT_RDMACM_CM_EP_CONNECTED     = UCS_BIT(2), /* connection was successfully
                                                    established */
    UCT_RDMACM_CM_EP_DISCONNECTED  = UCS_BIT(3), /* got disconnect event */
    UCT_RDMACM_CM_EP_DISCONNECTING = UCS_BIT(4), /* uct_ep_disconnect was called
                                                    on the ep. this ep is not
                                                    necessarily disconnected yet */
    UCT_RDMACM_CM_EP_FAILED        = UCS_BIT(5)  /* the EP is in error state, see
                                                    @ref uct_rdmacm_cm_ep_t::status */
};
